...
LEVELS += [
    {
        ...
        "saws": [
            {"x": 1150, "y": 430, "r": 20, "minX": 1080, "maxX": 1320, "speed": 190},
        ],
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 300, 40), "type": "solid"},
            {**rect(300, 480, 100, 20), "type": "moving", "axis": "x", "minX": 300, "maxX": 700, "speed": 110},
            {**rect(750, 500, 350, 40), "type": "solid"},
            {**rect(1100, 500, 100, 20), "type": "moving", "axis": "y", "minY": 340, "maxY": 500, "speed": 90},
    ...
    },
    {
        ...
        "saws": [
            {"x": 1150, "y": 430, "r": 20, "minX": 1080, "maxX": 1320, "speed": 200},
        ],
        "fallingBlocks": [
            {"x": 600, "y": -80, "w": 70, "h": 70, "triggerX": 470, "delay": 0.5, "groundY": 500},
            {"x": 2100, "y": -80, "w": 80, "h": 80, "triggerX": 1950, "delay": 0.45, "groundY": 500},
        ],
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 300, 40), "type": "solid"},
            {**rect(300, 480, 100, 20), "type": "moving", "axis": "x", "minX": 300, "maxX": 700, "speed": 120},
            {**rect(750, 500, 650, 40), "type": "solid"},
            {**rect(1400, 500, 100, 20), "type": "moving", "axis": "y", "minY": 340, "maxY": 500, "speed": 100},
        ...
        "bombs": [
            {"x": 1000, "kind": "sky", "y": -80, "triggerX": 850, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 900, "toX": 1350, "triggerX": 1100, "delay": 0.4, "speed": 280, "radius": 20},
        ],
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 400, 40), "type": "solid"},
            {**rect(400, 500, 150, 40), "type": "hidden_bomb", "triggerX": 430, "delay": 0.3, "blastRadius": 70},
        ...
        "saws": [
            {"x": 1800, "y": 370, "r": 20, "minX": 1700, "maxX": 1950, "speed": 230},
        ],
        "wallSpikes": [
            {"x": 1600, "y": 320, "w": 24, "h": 70, "reach": 40, "triggerX": 1550, "delay": 0.42, "dir": 1},
        ],
    },
    {
        ...
        "platforms": [
            ...
            {**rect(1250, 500, 150, 40), "type": "hidden_bomb", "triggerX": 1280, "delay": 0.3, "blastRadius": 70},
    ...
    },
    {
        ...
        "platforms": [
            ...
            {**rect(1600, 500, 100, 20), "type": "moving", "axis": "y", "minY": 340, "maxY": 500, "speed": 100},
        ...
        "bombs": [
            {"kind": "side", "y": 495, "dir": 1, "fromX": 1100, "toX": 1550, "triggerX": 1300, "delay": 0.4, "speed": 290, "radius": 20},
        ],
    },
    {
        ...
        "runWall": {"startX": -260, "speed": 130, "y": 0, "h": 620},
    },
    {
        ...
        "platforms": [
            ...
            {**rect(750, 500, 150, 40), "type": "hidden_bomb", "triggerX": 780, "delay": 0.3, "blastRadius": 70},
            {**rect(900, 480, 100, 20), "type": "moving", "axis": "x", "minX": 900, "maxX": 1300, "speed": 120},
            {**rect(1350, 500, 450, 40), "type": "stone"},
            {**rect(1800, 500, 100, 40), "type": "bounce"},
            {**rect(2050, 400, 450, 40), "type": "ice"},
            {**rect(2500, 400, 100, 20), "type": "moving", "axis": "y", "minY": 300, "maxY": 400, "speed": 90},
        ...
        "fallingBlocks": [
            {"x": 1550, "y": -80, "w": 80, "h": 80, "triggerX": 1400, "delay": 0.5, "groundY": 500},
        ],
        "bombs": [
            {"x": 2250, "kind": "sky", "y": -80, "triggerX": 2100, "delay": 0.5, "groundY": 400, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 295, "dir": 1, "fromX": 2600, "toX": 3100, "triggerX": 2800, "delay": 0.4, "speed": 300, "radius": 22},
        ],
    },
]
...
LEVELS += [
    {
        ...
        "saws": [
            {"x": 550, "y": 470, "r": 20, "minX": 450, "maxX": 650, "speed": 190},
            {"x": 1150, "y": 470, "r": 20, "minX": 1020, "maxX": 1330, "speed": 210},
        ],
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 300, 40), "type": "solid"},
            {**rect(300, 480, 100, 20), "type": "moving", "axis": "x", "minX": 300, "maxX": 650, "speed": 120},
            {**rect(700, 500, 300, 40), "type": "solid"},
            {**rect(1000, 500, 100, 20), "type": "moving", "axis": "y", "minY": 320, "maxY": 500, "speed": 100},
            {**rect(1000, 320, 300, 40), "type": "solid"},
            {**rect(1300, 320, 100, 20), "type": "moving", "axis": "x", "minX": 1300, "maxX": 1600, "speed": 110},
    ...
    },
    {
        ...
        "bombs": [
            {"x": 400, "kind": "sky", "y": -80, "triggerX": 250, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 900, "toX": 1350, "triggerX": 1100, "delay": 0.4, "speed": 290, "radius": 20},
            {"x": 2100, "kind": "sky", "y": -80, "triggerX": 1950, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
        ],
    },
    {
    ...
    },
    {
        ...
        "fallingBlocks": [
            {"x": 250, "y": -80, "w": 70, "h": 70, "triggerX": 120, "delay": 0.5, "groundY": 500},
            {"x": 950, "y": -80, "w": 70, "h": 70, "triggerX": 800, "delay": 0.5, "groundY": 500},
            {"x": 1900, "y": -80, "w": 80, "h": 80, "triggerX": 1750, "delay": 0.45, "groundY": 500},
        ],
    },
    {
        ...
        "bombs": [
            {"x": 900, "kind": "sky", "y": -80, "triggerX": 750, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 1700, "toX": 2200, "triggerX": 1900, "delay": 0.4, "speed": 300, "radius": 20},
            {"x": 2450, "kind": "sky", "y": -80, "triggerX": 2300, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
        ],
    },
    {
        ...
        "saws": [
            {"x": 900, "y": 470, "r": 20, "minX": 820, "maxX": 1020, "speed": 230},
            {"x": 1900, "y": 470, "r": 20, "minX": 1820, "maxX": 2020, "speed": 250},
        ],
        "wallSpikes": [
            {"x": 1450, "y": 390, "w": 24, "h": 70, "reach": 40, "triggerX": 1400, "delay": 0.42, "dir": 1},
        ],
        "runWall": {"startX": -180, "speed": 170, "y": 0, "h": 620},
    },
    {
        ...
        "platforms": [
            ...
            {**rect(300, 480, 100, 20), "type": "moving", "axis": "x", "minX": 300, "maxX": 650, "speed": 115},
            {**rect(700, 500, 300, 40), "type": "ice"},
            {**rect(1000, 500, 100, 40), "type": "bounce"},
            {**rect(1260, 420, 400, 40), "type": "ice"},
            {**rect(1660, 420, 100, 20), "type": "moving", "axis": "y", "minY": 300, "maxY": 420, "speed": 95},
    ...
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 400, 40), "type": "stone"},
            {**rect(400, 500, 400, 40), "type": "ice"},
            {**rect(800, 500, 150, 40), "type": "hidden_bomb", "triggerX": 830, "delay": 0.3, "blastRadius": 70},
            {**rect(950, 480, 100, 20), "type": "moving", "axis": "x", "minX": 950, "maxX": 1350, "speed": 120},
            {**rect(1400, 500, 450, 40), "type": "stone"},
            {**rect(1850, 500, 100, 40), "type": "bounce"},
            {**rect(2100, 400, 450, 40), "type": "ice"},
            {**rect(2550, 400, 100, 20), "type": "moving", "axis": "y", "minY": 300, "maxY": 400, "speed": 90},
        ...
        "bombs": [
            {"x": 2300, "kind": "sky", "y": -80, "triggerX": 2150, "delay": 0.5, "groundY": 400, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 295, "dir": 1, "fromX": 2650, "toX": 3200, "triggerX": 2850, "delay": 0.4, "speed": 300, "radius": 22},
        ],
    },
    {
        ...
        "saws": [
            {"x": 1700, "y": 310, "r": 20, "minX": 1600, "maxX": 1900, "speed": 230},
        ],
    },
    {
        ...
        "platforms": [
            ...
            {**rect(700, 480, 100, 20), "type": "moving", "axis": "x", "minX": 700, "maxX": 1050, "speed": 115},
            {**rect(1100, 460, 400, 40), "type": "solid"},
            {**rect(1500, 460, 100, 20), "type": "moving", "axis": "y", "minY": 340, "maxY": 460, "speed": 90},
    ...
    },
    {
        ...
        "bombs": [
            {"x": 400, "kind": "sky", "y": -80, "triggerX": 250, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 850, "toX": 1350, "triggerX": 1050, "delay": 0.4, "speed": 290, "radius": 20},
            {"x": 1950, "kind": "sky", "y": -80, "triggerX": 1800, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
            {"kind": "side", "y": 495, "dir": -1, "fromX": 2700, "toX": 2100, "triggerX": 2450, "delay": 0.4, "speed": 310, "radius": 22},
        ],
    },
    {
        ...
        "saws": [
            {"x": 650, "y": 470, "r": 20, "minX": 550, "maxX": 850, "speed": 200},
            {"x": 1450, "y": 430, "r": 20, "minX": 1350, "maxX": 1650, "speed": 220},
        ],
    },
    {
    ...
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 300, 40), "type": "solid"},
            {**rect(300, 500, 100, 20), "type": "moving", "axis": "y", "minY": 380, "maxY": 500, "speed": 90},
            {**rect(300, 380, 300, 40), "type": "solid"},
            {**rect(700, 380, 100, 20), "type": "moving", "axis": "y", "minY": 260, "maxY": 380, "speed": 95},
            {**rect(700, 260, 300, 40), "type": "solid"},
            {**rect(1100, 260, 100, 20), "type": "moving", "axis": "y", "minY": 190, "maxY": 260, "speed": 100},
    ...
    },
    {
        ...
        "bombs": [
            {"x": 1150, "kind": "sky", "y": -80, "triggerX": 1000, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 1550, "toX": 2050, "triggerX": 1900, "delay": 0.4, "speed": 300, "radius": 20},
            {"x": 2350, "kind": "sky", "y": -80, "triggerX": 2200, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
            {"kind": "side", "y": 495, "dir": -1, "fromX": 2850, "toX": 2400, "triggerX": 2600, "delay": 0.4, "speed": 320, "radius": 22},
        ],
    },
    {
        ...
        "bombs": [
            {"x": 700, "kind": "sky", "y": -80, "triggerX": 550, "delay": 0.5, "groundY": 500, "radius": 24, "blastRadius": 60},
            {"kind": "side", "y": 495, "dir": -1, "fromX": 1700, "toX": 1100, "triggerX": 1400, "delay": 0.4, "speed": 280, "radius": 20},
            {"x": 2000, "kind": "sky", "y": -80, "triggerX": 1850, "delay": 0.45, "groundY": 500, "radius": 26, "blastRadius": 65},
        ],
        "runWall": {"startX": -220, "speed": 150, "y": 0, "h": 620},
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 350, 40), "type": "solid"},
            {**rect(750, 500, 150, 40), "type": "hidden_bomb", "triggerX": 780, "delay": 0.3, "blastRadius": 70},
            {**rect(900, 480, 100, 20), "type": "moving", "axis": "x", "minX": 900, "maxX": 1250, "speed": 115},
            {**rect(1300, 500, 500, 40), "type": "solid"},
            {**rect(1800, 500, 150, 40), "type": "hidden_bomb", "triggerX": 1830, "delay": 0.3, "blastRadius": 70},
    ...
    },
    {
        ...
        "bombs": [
            {"x": 2300, "kind": "sky", "y": -80, "triggerX": 2150, "delay": 0.5, "groundY": 400, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 295, "dir": 1, "fromX": 2650, "toX": 3300, "triggerX": 2850, "delay": 0.4, "speed": 300, "radius": 22},
        ],
        "saws": [
            {"x": 2700, "y": 270, "r": 20, "minX": 2600, "maxX": 2850, "speed": 230},
        ],
        "wallSpikes": [
            {"x": 3050, "y": 220, "w": 24, "h": 70, "reach": 40, "triggerX": 3000, "delay": 0.42, "dir": 1},
        ],
    },
]
...
LEVELS += [
    {
        ...
        "saws": [
            {"x": 550, "y": 470, "r": 20, "minX": 470, "maxX": 620, "speed": 200},
            {"x": 750, "y": 470, "r": 20, "minX": 700, "maxX": 800, "speed": 210},
            {"x": 1160, "y": 430, "r": 20, "minX": 1100, "maxX": 1230, "speed": 210},
            {"x": 1380, "y": 430, "r": 20, "minX": 1310, "maxX": 1450, "speed": 220},
        ],
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 300, 40), "type": "solid"},
            {**rect(300, 500, 100, 20), "type": "moving", "axis": "y", "minY": 380, "maxY": 500, "speed": 95},
            {**rect(300, 380, 400, 40), "type": "solid"},
            {**rect(700, 380, 100, 20), "type": "moving", "axis": "y", "minY": 260, "maxY": 380, "speed": 100},
            {**rect(700, 260, 400, 40), "type": "solid"},
            {**rect(1100, 260, 100, 20), "type": "moving", "axis": "y", "minY": 190, "maxY": 260, "speed": 105},
            {**rect(1100, 190, 300, 40), "type": "solid"},
        ],
        "hazards": [
            {**rect(-50, 620, 1500, 40), "type": "void"},
        ...
        "bombs": [
            {"x": 500, "kind": "sky", "y": -80, "triggerX": 350, "delay": 0.5, "groundY": 380, "radius": 24, "blastRadius": 60},
            {"x": 900, "kind": "sky", "y": -80, "triggerX": 750, "delay": 0.5, "groundY": 260, "radius": 24, "blastRadius": 60},
        ],
    },
    {
    ...
    },
    {
        ...
        "bombs": [
            {"x": 300, "kind": "sky", "y": -80, "triggerX": 150, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 900, "toX": 1300, "triggerX": 1050, "delay": 0.4, "speed": 300, "radius": 20},
            {"x": 2000, "kind": "sky", "y": -80, "triggerX": 1850, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
            {"kind": "side", "y": 495, "dir": -1, "fromX": 2600, "toX": 2100, "triggerX": 2350, "delay": 0.4, "speed": 320, "radius": 22},
        ],
    },
    {
        ...
        "saws": [
            {"x": 830, "y": 470, "r": 18, "minX": 760, "maxX": 900, "speed": 190},
            {"x": 1520, "y": 470, "r": 18, "minX": 1470, "maxX": 1580, "speed": 200},
        ],
    },
    {
        ...
        "platforms": [
            ...
            {**rect(300, 300, 100, 20), "type": "moving", "axis": "y", "minY": 300, "maxY": 500, "speed": 110},
            {**rect(300, 500, 500, 40), "type": "ice"},
            {**rect(800, 460, 200, 40), "type": "solid"},
            {**rect(1000, 460, 100, 20), "type": "moving", "axis": "x", "minX": 1000, "maxX": 1350, "speed": 115},
    ...
    },
    {
        ...
        "platforms": [
            ...
            {**rect(900, 500, 150, 40), "type": "hidden_spike", "triggerX": 930, "delay": 0.28},
            {**rect(1050, 500, 150, 40), "type": "fake_floor"},
            {**rect(1200, 500, 350, 40), "type": "solid"},
            {**rect(1550, 500, 150, 40), "type": "hidden_bomb", "triggerX": 1580, "delay": 0.3, "blastRadius": 70},
            {**rect(1700, 500, 150, 40), "type": "hidden_spike", "triggerX": 1730, "delay": 0.28},
    ...
    },
    {
        ...
        "saws": [
            {"x": 1100, "y": 390, "r": 20, "minX": 1020, "maxX": 1220, "speed": 230},
            {"x": 1900, "y": 390, "r": 20, "minX": 1820, "maxX": 2020, "speed": 250},
        ],
        "runWall": {"startX": -200, "speed": 160, "y": 0, "h": 620},
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 350, 40), "type": "solid"},
            {**rect(800, 500, 150, 40), "type": "hidden_bomb", "triggerX": 830, "delay": 0.3, "blastRadius": 70},
            {**rect(950, 480, 100, 20), "type": "moving", "axis": "x", "minX": 950, "maxX": 1300, "speed": 115},
            {**rect(1350, 500, 500, 40), "type": "solid"},
            {**rect(1850, 500, 150, 40), "type": "hidden_bomb", "triggerX": 1880, "delay": 0.3, "blastRadius": 70},
        ...
        "bombs": [
            {"kind": "side", "y": 495, "dir": 1, "fromX": 1450, "toX": 1950, "triggerX": 1650, "delay": 0.4, "speed": 300, "radius": 20},
        ],
    },
    {
        ...
        "platforms": [
            ...
            {**rect(2500, 420, 100, 20), "type": "moving", "axis": "y", "minY": 320, "maxY": 420, "speed": 95},
            {**rect(2500, 320, 450, 40), "type": "stone"},
            {**rect(2950, 320, 150, 40), "type": "hidden_spike", "triggerX": 2980, "delay": 0.28},
        ...
        "bombs": [
            {"x": 2280, "kind": "sky", "y": -80, "triggerX": 2150, "delay": 0.5, "groundY": 420, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 315, "dir": 1, "fromX": 3150, "toX": 3550, "triggerX": 3300, "delay": 0.4, "speed": 300, "radius": 22},
        ],
        "saws": [
            {"x": 1600, "y": 470, "r": 18, "minX": 1400, "maxX": 1700, "speed": 220},
        ],
        "wallSpikes": [
            {"x": 2650, "y": 280, "w": 24, "h": 70, "reach": 40, "triggerX": 2600, "delay": 0.42, "dir": 1},
        ],
    },
]
...
LEVELS += [
    {
        ...
        "saws": [
            {"x": 550, "y": 470, "r": 20, "minX": 470, "maxX": 650, "speed": 210},
            {"x": 1250, "y": 470, "r": 20, "minX": 1150, "maxX": 1350, "speed": 220},
            {"x": 2100, "y": 470, "r": 20, "minX": 2000, "maxX": 2200, "speed": 230},
            {"x": 2500, "y": 470, "r": 20, "minX": 2400, "maxX": 2600, "speed": 240},
        ],
    },
    {
        ...
        "platforms": [
            ...
            {**rect(300, 380, 400, 40), "type": "solid"},
            {**rect(700, 380, 100, 20), "type": "moving", "axis": "y", "minY": 260, "maxY": 380, "speed": 100},
            {**rect(700, 260, 150, 40), "type": "hidden_spike", "triggerX": 730, "delay": 0.28},
    ...
    },
    {
        ...
        "saws": [
            {"x": 850, "y": 390, "r": 20, "minX": 760, "maxX": 1000, "speed": 210},
            {"x": 1750, "y": 310, "r": 20, "minX": 1650, "maxX": 1900, "speed": 230},
        ],
    },
    {
    ...
    },
    {
        ...
        "fallingBlocks": [
            {"x": 900, "y": -80, "w": 70, "h": 70, "triggerX": 770, "delay": 0.5, "groundY": 500},
        ],
        "bombs": [
            {"kind": "side", "y": 495, "dir": 1, "fromX": 1600, "toX": 2100, "triggerX": 1850, "delay": 0.4, "speed": 300, "radius": 20},
            {"x": 2400, "kind": "sky", "y": -80, "triggerX": 2250, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
        ],
    },
    {
        ...
        "saws": [
            {"x": 650, "y": 470, "r": 20, "minX": 550, "maxX": 850, "speed": 210},
            {"x": 1450, "y": 430, "r": 20, "minX": 1350, "maxX": 1650, "speed": 220},
        ],
        "wallSpikes": [
            {"x": 2400, "y": 430, "w": 24, "h": 70, "reach": 40, "triggerX": 2350, "delay": 0.42, "dir": 1},
        ],
    },
    {
        ...
        "platforms": [
            ...
            {**rect(500, 500, 150, 40), "type": "hidden_bomb", "triggerX": 530, "delay": 0.3, "blastRadius": 70},
            {**rect(650, 500, 650, 40), "type": "solid"},
            {**rect(1300, 500, 150, 40), "type": "hidden_spike", "triggerX": 1330, "delay": 0.28},
            {**rect(1450, 500, 1050, 40), "type": "solid"},
        ],
        "hazards": [
            {**rect(-50, 620, 2600, 40), "type": "void"},
        ],
        "runWall": {"startX": -200, "speed": 155, "y": 0, "h": 620},
    },
    {
        ...
        "platforms": [
            ...
            {**rect(700, 500, 300, 40), "type": "solid"},
            {**rect(1400, 500, 300, 40), "type": "solid"},
            {**rect(1700, 500, 100, 20), "type": "moving", "axis": "y", "minY": 340, "maxY": 500, "speed": 95},
    ...
    },
    {
        ...
        "bombs": [
            {"x": 2280, "kind": "sky", "y": -80, "triggerX": 2150, "delay": 0.5, "groundY": 420, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 315, "dir": 1, "fromX": 2650, "toX": 3200, "triggerX": 2850, "delay": 0.4, "speed": 300, "radius": 22},
        ],
    },
]
...
LEVELS += [
    {
        ...
        "saws": [
            {"x": 650, "y": 470, "r": 20, "minX": 550, "maxX": 850, "speed": 210},
            {"x": 1450, "y": 430, "r": 20, "minX": 1350, "maxX": 1650, "speed": 220},
            {"x": 2400, "y": 470, "r": 20, "minX": 2300, "maxX": 2600, "speed": 230},
        ],
    },
    {
        ...
        "platforms": [
            ...
            {**rect(300, 500, 100, 20), "type": "moving", "axis": "y", "minY": 380, "maxY": 500, "speed": 95},
            {**rect(300, 380, 400, 40), "type": "solid"},
            {**rect(700, 380, 100, 20), "type": "moving", "axis": "x", "minX": 700, "maxX": 1050, "speed": 115},
            {**rect(1100, 380, 300, 40), "type": "solid"},
            {**rect(1400, 380, 100, 20), "type": "moving", "axis": "y", "minY": 260, "maxY": 380, "speed": 100},
        ...
        "bombs": [
            {"x": 1700, "kind": "sky", "y": -80, "triggerX": 1550, "delay": 0.5, "groundY": 260, "radius": 26, "blastRadius": 65},
        ],
    },
    {
        ...
        "bombs": [
            {"x": 350, "kind": "sky", "y": -80, "triggerX": 200, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 800, "toX": 1300, "triggerX": 1000, "delay": 0.4, "speed": 290, "radius": 20},
            {"x": 1950, "kind": "sky", "y": -80, "triggerX": 1800, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
            {"kind": "side", "y": 495, "dir": -1, "fromX": 2900, "toX": 2300, "triggerX": 2600, "delay": 0.4, "speed": 320, "radius": 22},
            {"x": 2500, "kind": "sky", "y": -80, "triggerX": 2350, "delay": 0.45, "groundY": 500, "radius": 26, "blastRadius": 65},
        ],
    },
    {
        ...
        "saws": [
            {"x": 1250, "y": 310, "r": 18, "minX": 1150, "maxX": 1350, "speed": 210},
        ],
    },
    {
    ...
    },
    {
        ...
        "saws": [
            {"x": 1150, "y": 430, "r": 20, "minX": 1080, "maxX": 1320, "speed": 210},
        ],
        "bombs": [
            {"x": 600, "kind": "sky", "y": -80, "triggerX": 470, "delay": 0.5, "groundY": 500, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 495, "dir": 1, "fromX": 1800, "toX": 2300, "triggerX": 2050, "delay": 0.4, "speed": 300, "radius": 20},
            {"x": 2600, "kind": "sky", "y": -80, "triggerX": 2450, "delay": 0.45, "groundY": 500, "radius": 28, "blastRadius": 70},
        ],
    },
    {
        ...
        "saws": [
            {"x": 500, "y": 470, "r": 20, "minX": 420, "maxX": 620, "speed": 220},
            {"x": 1000, "y": 470, "r": 20, "minX": 920, "maxX": 1120, "speed": 230},
            {"x": 1500, "y": 470, "r": 20, "minX": 1420, "maxX": 1620, "speed": 240},
            {"x": 2000, "y": 470, "r": 20, "minX": 1920, "maxX": 2120, "speed": 250},
        ],
    },
    {
        ...
        "wallSpikes": [
            {"x": 1500, "y": 390, "w": 24, "h": 70, "reach": 40, "triggerX": 1450, "delay": 0.42, "dir": 1},
        ],
        "runWall": {"startX": -200, "speed": 165, "y": 0, "h": 620},
    },
    {
    ...
    },
    {
        ...
        "platforms": [
            {**rect(0, 500, 400, 40), "type": "solid"},
            {**rect(400, 500, 150, 40), "type": "hidden_spike", "triggerX": 430, "delay": 0.28},
            {**rect(550, 500, 400, 40), "type": "ice"},
            {**rect(950, 460, 200, 40), "type": "solid"},
            {**rect(1150, 460, 150, 40), "type": "hidden_bomb", "triggerX": 1180, "delay": 0.3, "blastRadius": 70},
            {**rect(1300, 460, 500, 40), "type": "stone"},
            {**rect(1800, 440, 100, 20), "type": "moving", "axis": "x", "minX": 1800, "maxX": 2200, "speed": 120},
            {**rect(2250, 460, 450, 40), "type": "stone"},
            {**rect(2700, 460, 100, 40), "type": "bounce"},
            {**rect(2960, 380, 440, 40), "type": "ice"},
            {**rect(3400, 380, 100, 20), "type": "moving", "axis": "y", "minY": 280, "maxY": 380, "speed": 95},
        ...
        "fallingBlocks": [
            {"x": 700, "y": -80, "w": 70, "h": 70, "triggerX": 570, "delay": 0.5, "groundY": 500},
        ],
        "bombs": [
            {"x": 2450, "kind": "sky", "y": -80, "triggerX": 2300, "delay": 0.5, "groundY": 460, "radius": 26, "blastRadius": 65},
            {"kind": "side", "y": 455, "dir": 1, "fromX": 1350, "toX": 1750, "triggerX": 1550, "delay": 0.4, "speed": 290, "radius": 20},
            {"kind": "side", "y": 275, "dir": 1, "fromX": 3300, "toX": 3700, "triggerX": 3500, "delay": 0.4, "speed": 300, "radius": 22},
        ],
        "saws": [
            {"x": 3150, "y": 350, "r": 18, "minX": 3050, "maxX": 3250, "speed": 220},
        ],
        "wallSpikes": [
            {"x": 3800, "y": 230, "w": 24, "h": 70, "reach": 40, "triggerX": 3750, "delay": 0.42, "dir": 1},
        ],
    },
]
